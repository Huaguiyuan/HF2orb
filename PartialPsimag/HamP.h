...
*/
				...
				ix=isite+(orb1+spin1*numOrb)*volume_;
				iy=isite+(orb2+spin2*numOrb)*volume_;
				ham(ix,iy)=ham(ix,iy) - 4*jj*spy;// - uu*spx;
				ham(iy,ix)=conj(ham(ix,iy));
				...
				ix=isite+(orb1+spin1*numOrb)*volume_;
				iy=isite+(orb2+spin2*numOrb)*volume_;
				ham(ix,iy)=ham(ix,iy) - jj*opy; //- (up - jj/2)*opx - 2*jj*opx;
				ham(iy,ix)=conj(ham(ix,iy));
				...
				ix=isite+(orb1+spin1*numOrb)*volume_;
				iy=isite+(orb2+spin2*numOrb)*volume_;
				ham(ix,iy)=ham(ix,iy) - jj*opx; //- (up - jj/2)*opy - 2*jj*opy;
				ham(iy,ix)=conj(ham(ix,iy));
				...
				ix=isite+(orb1+spin1*numOrb)*volume_;
				iy=isite+(orb2+spin2*numOrb)*volume_;
				ham(ix,iy)=ham(ix,iy) -4*jj*spx; //- uu*spy;
				ham(iy,ix)=conj(ham(ix,iy));
